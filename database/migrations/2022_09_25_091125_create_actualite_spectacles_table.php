...
class CreateActualiteSpectaclesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('actualite_spectacles', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('actualite_spectacles');
    }
}
